...
/**
 * Interfaz que define el contrato para el servicio de envío de notificaciones por correo electrónico.
 */
public interface InterfazEnviarEmails {
	 ...
	 * @return true si el correo se envió con éxito, false en caso de fallo o error de red.
	 */
